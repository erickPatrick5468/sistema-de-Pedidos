...
public class UsuarioBean implements Serializable {
	...
	public void salvar() {
		...
		RequestContext.getCurrentInstance().update(Arrays.asList("frm:usuarioDataTable", "frm:messages"));
	...
	public String login() {
		usuarioAutenticado = usuarioService.autenticar(usuario.getEmail(), usuario.getSenha());
